  ...
  <Wrapper id="about">
    <SkillsWrapper as={Container}>
      ...
      <Details>
        ...
        my experience in Python Django. Golang & JavaScript libraries like ReactJs, & Bash. I love open source software especially GNU Linux. my favorite distribution fedora silverblue. working on containerzation technologies like <a href="https://www.docker.com/" target="_blank">docker</a> and <a href="https://kubernetes.io/" target="_blank">kubernetes.</a><a href="https://www.kubeflow.org/" target="_blank"> kubeflow</a>.
        </p>
